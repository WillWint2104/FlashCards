...
(function () {
  ...
  const ES = { subject: null, code: "", demo: false, screen: "setup", draft: null, list: [], form: null, pending: false,
    ui: { polishOpen: false, miss: {}, frame: {}, frameOpen: {} },  // transient coached-view state, reset on paragraph change
  ...
  function esResetCoachUI() { ES.ui = { polishOpen: false, miss: {}, frame: {}, frameOpen: {} }; }
  ...
  function esCoachMargin(p) {
    ...
    const fb = p.feedback;
    if (!fb) return `<div class="es-mempty">The shape of this paragraph is under the box: each row is one sentence and the job it does. Ask for a frame on any row you are stuck on. When you have written it, press <b>Get feedback</b> and suggestions appear here. The coach never rewrites your paragraph for you.</div>`;
