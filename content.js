  ...
  areas: [
    ...
    },
    {
      ...
      cards: [
        ...
        { id:"lr5", type:"essay", marks:12, command:"Analyse",
          prompt:"Analyse the main causes of inequality in the distribution of income in Australia.",
          vocab:["labour market","education and skills","occupation","decentralised wage determination","capital ownership","age and life cycle","gender","family structure"],
          scaffold:[
            "Group the causes: labour-market factors, ownership of capital, and demographic dimensions.",
            "Explain each causally rather than as a list: how skills, education, occupation and decentralised bargaining widen wage dispersion; how income from assets concentrates among the wealthy; how age, gender and family structure overlay the distribution.",
            "Weight them: labour-market and capital-ownership factors as the structural drivers, demographic factors as overlays.",
            "Conclude with a synthesised judgement about which causes matter most."],
          model:"A strong response groups the causes into labour-market factors, ownership of capital and demographic dimensions, explains each with cause and effect rather than listing, weights labour-market and capital-ownership factors as the structural drivers with demographic factors as overlays, and concludes with a synthesised judgement about which causes matter most.",
          faults:[
            { kind:"fix", severity:"critical", head:"Explain each cause, do not list",
              why:"Analyse means cause and effect. For each cause, state the mechanism that turns it into unequal income.",
              ladder:[
                { level:"Clear", text:"Differences in education and skills cause unequal wages, because higher skills command higher pay." },
                { level:"Better", text:"Because wages reward skills and qualifications, gaps in education and training feed directly into income inequality." },
                { level:"Band 6", text:"Skill and education differences widen wage dispersion, and decentralised bargaining lets that dispersion translate into a more unequal income distribution." }]},
            { kind:"fix", severity:"should", head:"Weight the causes",
              why:"A top response does not treat every cause as equal. Judge which are structural drivers and which are overlays.",
              ladder:[
                { level:"Clear", text:"Labour-market and capital factors are the main causes, with age and gender adding to them." },
                { level:"Better", text:"Labour-market and capital-ownership factors are the structural drivers, while demographic factors overlay the pattern." },
                { level:"Band 6", text:"The structural drivers are labour-market dispersion and concentrated capital ownership, while demographic factors such as age, gender and family structure shape who sits where without driving the overall level." }]}
          ]},
        { id:"lr8", type:"essay", marks:12, command:"Examine",
          prompt:"Examine the recent trends in the distribution of income and wealth in Australia.",
          vocab:["trend","quintile shares","Gini coefficient","wealth concentration","asset prices","housing"],
          scaffold:[
            "Examine income trends: relative stability or gradual change in the income Gini, with the top quintile holding a disproportionate share.",
            "Examine wealth trends: greater and arguably widening concentration, driven heavily by asset and house prices.",
            "Connect the trends to drivers: asset-price growth concentrating wealth gains, and labour-market changes affecting wage dispersion.",
            "Note dimensional patterns such as age and gender, and conclude with a judgement on the direction and drivers."],
          model:"A strong response examines income trends, with the income Gini relatively stable and the top quintile holding a disproportionate share, and wealth trends, where concentration is greater and arguably widening on the back of asset and house prices, links the trends to drivers such as asset-price growth and labour-market change, notes dimensional patterns, and concludes with a judgement. Trend figures are left general because specific statistics date quickly.",
          faults:[
            { kind:"fix", severity:"critical", head:"Give the driver behind each trend",
              why:"Examine means inspect closely. For each trend, name what is driving it, not just the direction.",
              ladder:[
                { level:"Clear", text:"Wealth inequality has risen, driven mainly by rising house and asset prices." },
                { level:"Better", text:"Wealth concentration has widened largely because asset and house prices have grown, lifting the holdings of those who already own assets." },
                { level:"Band 6", text:"The widening of wealth concentration tracks asset-price growth, since gains accrue to existing owners, while income inequality has moved less because wages have been comparatively stable." }]},
            { kind:"fix", severity:"should", head:"Separate the income and wealth trends",
              why:"The two move differently: income inequality has been comparatively stable, while wealth concentration has widened more.",
              ladder:[
                { level:"Clear", text:"Income inequality has been fairly stable, but wealth inequality has grown faster." },
                { level:"Better", text:"The income Gini has changed only gradually, whereas wealth concentration has widened more noticeably." },
                { level:"Band 6", text:"Income and wealth trends diverge: the income distribution has been relatively stable while wealth has concentrated further, largely through asset prices." }]}
          ]}
      ]
    },
    {
      ...
      cards: [
        ...
        { id:"lr6", type:"essay", marks:15, command:"Discuss",
          prompt:"Discuss the economic and social consequences of an unequal distribution of income and wealth in Australia.",
          vocab:["incentive to work","saving and investment","aggregate demand","poverty","social mobility","social cohesion","equity-efficiency trade-off"],
          scaffold:[
            "Present both sides, since the command is Discuss: some inequality has economic benefits such as incentives to work, save, invest and take risks.",
            "Set against this the economic costs (reduced consumption from concentrated income, underused human capital, the fiscal cost of support) and the social costs (poverty, reduced social mobility, weaker cohesion).",
            "Introduce the equity-efficiency trade-off as the framing tension.",
            "Reach a balanced judgement: some inequality is unavoidable and even useful, but high or entrenched inequality imposes net costs."],
          model:"A strong response discusses both sides: the incentive and saving benefits of some inequality, set against the economic costs of weaker consumption, underused human capital and fiscal support, and the social costs of poverty, reduced mobility and weaker cohesion, frames the tension as the equity-efficiency trade-off, and reaches a balanced judgement that some inequality is useful but high or entrenched inequality is costly.",
          faults:[
            { kind:"fix", severity:"critical", head:"Discuss both sides",
              why:"Discuss requires both sides. If you give only the costs, add the incentive and saving benefits of some inequality.",
              ladder:[
                { level:"Clear", text:"Some inequality has benefits, because the reward for skills and effort encourages people to work and invest." },
                { level:"Better", text:"A degree of inequality can support growth, since differential rewards create incentives to work, save and take risks." },
                { level:"Band 6", text:"Some inequality is economically useful, since differential rewards drive effort, skill formation and investment, which is why the issue is a trade-off rather than a simple harm." }]},
            { kind:"fix", severity:"should", head:"Frame the trade-off",
              why:"Name the equity-efficiency trade-off as the tension that organises the discussion.",
              ladder:[
                { level:"Clear", text:"There is a trade-off between equity and efficiency in how income is shared." },
                { level:"Better", text:"The consequences sit within the equity-efficiency trade-off, since more redistribution can mean weaker incentives." },
                { level:"Band 6", text:"The equity-efficiency trade-off frames the whole question, because reducing inequality improves equity but may blunt the incentives that support efficiency." }]}
          ]},
        { id:"lr7", type:"essay", marks:12, command:"Analyse",
          prompt:"Analyse the economic and social costs of inequality in the distribution of income.",
          vocab:["absolute poverty","relative poverty","poverty line","social mobility","human capital","social wage","welfare dependence"],
          scaffold:[
            "Distinguish economic costs (lost output from underused human capital, lower aggregate consumption, the fiscal cost of support) from social costs (poverty, reduced mobility, health and education gaps, weaker cohesion).",
            "Use cause and effect to connect inequality to each cost.",
            "Note that relative poverty and reduced social mobility are the most persistent harms.",
            "Conclude with a judgement on the overall significance of the costs."],
          model:"A strong response separates economic costs (underused human capital, weaker consumption, fiscal cost) from social costs (poverty, reduced mobility, health and education gaps, weaker cohesion), connects each to inequality causally, notes that relative poverty and low social mobility are the most persistent harms, and concludes with a judgement on the overall significance of the costs.",
          faults:[
            { kind:"fix", severity:"should", head:"Separate economic from social costs",
              why:"Group the costs clearly: economic costs reduce output and efficiency, while social costs harm wellbeing and fairness.",
              ladder:[
                { level:"Clear", text:"An economic cost is lost output, while a social cost is the harm of poverty." },
                { level:"Better", text:"Economic costs such as underused human capital reduce output, whereas social costs such as poverty and weaker mobility harm wellbeing." },
                { level:"Band 6", text:"Inequality imposes economic costs by leaving human capital underused and consumption weak, and distinct social costs through poverty, poorer health and reduced mobility." }]},
            { kind:"fix", severity:"should", head:"Distinguish absolute and relative poverty",
              why:"Separate {{absolute poverty|Lacking the income for basic needs.|0}} from {{relative poverty|Income well below the community median, so a household cannot participate normally.|0}}, since relative poverty is the more relevant measure in Australia.",
              ladder:[
                { level:"Clear", text:"Relative poverty means living well below the typical income, not being unable to survive." },
                { level:"Better", text:"Absolute poverty is lacking basic needs, while relative poverty is falling well below the community standard, the measure that matters most in Australia." },
                { level:"Band 6", text:"In a high-income economy the binding harm is relative poverty, where households fall far below median income and cannot participate fully, rather than absolute poverty." }]}
          ]},
        { id:"lr12", type:"essay", marks:20, command:"To what extent",
          ...
          scaffold:[
            ...
            "Use the stimulus, income versus wealth, as evidence of where Australia currently sits.",
            "Argue the extent: Australia accepts considerable inequality for efficiency and incentive reasons but tempers it with progressive tax, transfers and the social wage, so the distribution is a managed compromise rather than a pure market outcome.",
            "Reach a sustained judgement on the degree."],
          model:"A sustained response argues the distribution reflects the trade-off to a significant but not total extent, explains that market outcomes reward efficiency while redistribution improves equity at some cost to incentives, uses the income versus wealth stimulus as evidence of where Australia sits, argues that Australia accepts considerable inequality for efficiency reasons but tempers it through tax, transfers and the social wage, and reaches a sustained judgement on the degree.",
          faults:[
            { kind:"fix", severity:"critical", head:"Answer the degree, not yes or no",
              why:"To what extent asks for a degree. Argue how much, with a qualifier such as significantly, partly or largely, rather than a simple yes or no.",
              ladder:[
                { level:"Clear", text:"The distribution reflects the trade-off to a significant extent, but not completely." },
                { level:"Better", text:"Australia's distribution reflects the trade-off to a large but not total extent, since policy softens market outcomes." },
                { level:"Band 6", text:"The distribution reflects the trade-off to a significant degree but not fully, because progressive tax and transfers deliberately temper the market outcome, making it a managed compromise." }]},
            { kind:"fix", severity:"should", head:"Define equity and efficiency",
              why:"Anchor the answer by defining both {{equity|Fairness in how income and wealth are distributed.|0}} and {{efficiency|Using resources so as to maximise output and welfare.|0}}.",
              ladder:[
                { level:"Clear", text:"Equity is fairness in the distribution, while efficiency is making the most of resources." },
                { level:"Better", text:"Equity concerns fairness in how income and wealth are shared, and efficiency concerns using resources to maximise output." },
                { level:"Band 6", text:"Equity is fairness in the distribution and efficiency is the productive use of resources, and the trade-off arises because improving one can come at the cost of the other." }]}
          ]}
      ]
    },
    {
      ...
      cards: [
        ...
        { id:"lr9", type:"essay", marks:20, command:"Discuss",
          ...
          scaffold:[
            ...
            "Policies: progressive tax and transfers as the direct redistributive tools, the social wage, wage determination and the minimum wage, and education and training to address the causes.",
            "Evaluation: weigh each policy's effectiveness and its trade-off, and reach a sustained judgement."],
          model:"A sustained response sets a thesis that inequality has economic and social consequences and that several policies reduce it with trade-offs, draws on the Lorenz and income-source stimulus as evidence of the distribution and its costs, develops the direct tools (progressive tax, transfers, the social wage) and the structural tools (wage determination, education and training), and evaluates each policy's effectiveness and trade-off to reach a sustained judgement.",
          faults:[
            { kind:"fix", severity:"critical", head:"Bridge from consequences to policy",
              why:"The question has two parts. After the consequences, turn to the policies that address them.",
              ladder:[
                { level:"Clear", text:"These consequences can be reduced by government policies such as progressive tax and transfers." },
                { level:"Better", text:"Because these costs stem from the market distribution, government uses progressive tax, transfers and the social wage to reduce them." },
                { level:"Band 6", text:"Having shown the costs of the current distribution, the response turns to policy: progressive tax and transfers treat the symptoms each year, while education and training address the underlying causes." }]},
            { kind:"fix", severity:"critical", head:"Use the stimulus as evidence",
              why:"The question says to refer to the information provided. Describe the distribution it shows and build the argument on it.",
              ladder:[
                { level:"Clear", text:"The stimulus shows the disposable curve closer to equality than the gross curve, so the system already reduces income inequality." },
                { level:"Better", text:"As the stimulus shows, the gap between the gross and disposable curves measures how far tax and transfers compress the distribution." },
                { level:"Band 6", text:"The stimulus anchors the argument: the inward shift from the gross to the disposable curve quantifies the income effect, while the income-source data shows why wage dispersion drives the underlying inequality." }]}
          ]},
        { id:"lr10", type:"essay", marks:20, command:"Evaluate",
          ...
          scaffold:[
            ...
            "Mechanism: progressive tax through vertical equity, plus means-tested transfers, compress the income distribution each year.",
            "The limit: wealth is lightly taxed, so the system barely touches the more unequal wealth distribution.",
            "Evaluation: effective on income, weak on wealth, with the equity-efficiency trade-off as a constraint, and a sustained judgement."],
          model:"A sustained response argues the system substantially reduces income inequality but is weak on wealth, uses the before and after Lorenz stimulus as evidence of the income effect, explains the mechanism of progressive tax and means-tested transfers, identifies the limit that wealth is lightly taxed, and evaluates the system as effective on income and weak on wealth within the equity-efficiency trade-off, reaching a sustained judgement.",
          faults:[
            { kind:"fix", severity:"critical", head:"Evaluate wealth, not only income",
              why:"The question covers income and wealth. After the income effect, judge how little the system does for wealth inequality.",
              ladder:[
                { level:"Clear", text:"The system is far less effective on wealth, because wealth is barely taxed." },
                { level:"Better", text:"While the system compresses income each year, it barely touches wealth, which is lightly taxed and far more concentrated." },
                { level:"Band 6", text:"The system is effective on income but weak on wealth, since there is no broad wealth tax and assets are treated concessionally, leaving the more unequal wealth distribution largely intact." }]},
            { kind:"fix", severity:"should", head:"Judge effectiveness, do not overstate",
              why:"Evaluate means weigh effectiveness against limits. Avoid claiming the system proves or solves inequality.",
              ladder:[
                { level:"Clear", text:"The system substantially reduces income inequality, though it does not remove it." },
                { level:"Better", text:"On income the system is effective, compressing the distribution, but it is constrained by the equity-efficiency trade-off." },
                { level:"Band 6", text:"Weighing both sides, the system is effective on income and weak on wealth, a measured judgement rather than a claim that it solves inequality." }]}
          ]},
        { id:"lr11", type:"essay", marks:20, command:"Assess",
          prompt:"Assess the role of government policy in achieving a more equitable distribution of income and wealth in Australia.",
          vocab:["equity","horizontal equity","vertical equity","fiscal policy","progressive taxation","transfer payments","social wage","education","equity-efficiency trade-off"],
          scaffold:[
            "Thesis: government uses several policy levers to improve equity, with real but bounded effect.",
            "Direct redistribution (tax and transfers) and the social wage as the primary tools, with their measurable effect on the income distribution.",
            "Indirect and structural policies (education, training, labour-market settings) that address the causes of inequality over the longer term.",
            "Assessment: weigh effectiveness against limits and trade-offs, such as incentive effects, fiscal cost and limited reach on wealth, and reach a judgement on the overall role."],
          model:"A sustained response sets a thesis that government has several levers with real but bounded effect, develops the direct tools (tax, transfers, the social wage) and their effect on the income distribution, adds the structural tools (education, training, labour-market settings) that address the causes, and assesses effectiveness against limits and trade-offs to reach a judgement on the overall role.",
          faults:[
            { kind:"fix", severity:"critical", head:"Assess effectiveness, do not just describe",
              why:"Assess means judge value. For each policy, weigh how well it works and its limits, not just what it does.",
              ladder:[
                { level:"Clear", text:"Progressive tax and transfers reduce income inequality, but their reach on wealth is limited." },
                { level:"Better", text:"Tax and transfers measurably compress income, though their effect is bounded by incentive costs and the light taxation of wealth." },
                { level:"Band 6", text:"Tax and transfers are effective on income but limited on wealth and constrained by incentive effects, so their role is significant yet bounded, which is the judgement an assessment requires." }]},
            { kind:"fix", severity:"should", head:"Define equity",
              why:"Anchor the answer by defining equity, and distinguish {{horizontal equity|Treating people in the same situation the same way.|0}} from {{vertical equity|Those who can afford more contribute more.|0}}.",
              ladder:[
                { level:"Clear", text:"Equity means fairness in how income and wealth are shared." },
                { level:"Better", text:"Equity means fairness in the distribution, including vertical equity where higher earners contribute proportionally more." },
                { level:"Band 6", text:"Equity combines vertical equity, where those with greater capacity contribute more, and horizontal equity, where like cases are treated alike, and policy is judged against both." }]}
          ]}
      ]
    }
  ]
          ...
          issues: [
            {
              ...
              ladder: [
                { level: "Clear", text: "The disposable-income Gini falls from 0.436 to 0.324 once tax and transfers apply." },
                { level: "Better", text: "Comparing the gross Gini of 0.436 with the disposable Gini of 0.324 shows the system's redistributive effect." },
                { level: "Band 6", text: "The income Gini falls from 0.436 before tax and transfers to 0.324 after them, a direct measure of how much the system compresses the distribution." }
              ]
            }
          ]
        },
          ...
          issues: [
            {
              ...
              ladder: [
                { level: "Clear", text: "This shows the system substantially reduces income inequality." },
                { level: "Better", text: "This substantially compresses the income distribution, the system's central aim." },
                { level: "Band 6", text: "This demonstrates a substantial compression of the income distribution, the system's central redistributive aim." }
              ]
            },
            {
              ...
              ladder: [
                { level: "Clear", text: "It reduces the gap between high and low income earners." },
                { level: "Better", text: "It narrows the gap between the highest and lowest income quintiles each year." },
                { level: "Band 6", text: "It narrows the gap between the top and bottom quintiles, the criterion on which redistributive effectiveness is judged." }
              ]
            }
          ]
        },
          ...
          issues: [
            {
              ...
              ladder: [
                { level: "Clear", text: "Progressive tax and means-tested transfers drive this reduction each year." },
                { level: "Better", text: "Progressive taxation and means-tested transfers are the two mechanisms driving this annual reduction." },
                { level: "Band 6", text: "Progressive taxation and tightly means-tested transfers are the mechanisms behind this annual compression, redistributing roughly a third of revenue to lower earners." }
              ]
            },
            {
              ...
              ladder: [
                { level: "Clear", text: "This reflects vertical equity, since higher earners contribute a higher proportion." },
                { level: "Better", text: "This reflects vertical equity, as those who earn more contribute proportionally more." },
                { level: "Band 6", text: "This embodies vertical equity, since proportionally higher contributions from high earners fund the transfers that compress the distribution." }
              ]
            }
          ]
        },
          ...
          issues: [
            {
              ...
              ladder: [
                { level: "Clear", text: "However, this success on income does not extend to wealth." },
                { level: "Better", text: "The same system that compresses income, however, leaves the far more unequal distribution of wealth largely untouched." },
                { level: "Band 6", text: "Yet the very mechanisms that compress income, progressive tax and transfers, barely reach wealth, which is why the wealth distribution remains close to twice as unequal." }
              ]
            }
          ]
        }
