...
(async()=>{
  ...
  await p.click('[data-estool="evidence"]'); await settled(p);
  ...
  await p.click('[data-estool="understand"]'); await settled(p);
  ...
  await p.$$eval('[data-esok]',es=>es[0].click()); await settled(p);
