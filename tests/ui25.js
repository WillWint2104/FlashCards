...
(async()=>{
  ...
  await p.click('#esposdefer'); await p.waitForTimeout(400);
  ...
  await p.click('#esplanless'); await p.waitForTimeout(300);
  ...
  await p.click('#esposopen'); await p.waitForTimeout(350);
  ...
  await p.click('#esposkeep'); await p.waitForTimeout(400);
