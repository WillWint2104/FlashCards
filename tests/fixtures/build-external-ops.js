    ...
    guidance: {
      ...
      explain: { direct: "Explain WHY an earlier check means fewer faults reach the customer. Name the step in the middle, not the result.",
        ladder: [
          ...
          { rung: "example", context: "a proofreader and a long manuscript",
            pattern: "where the check happens, then what is not wasted when it finds something",
            text: "In a different context: a proofreader who reads each chapter as it is written finds a wrong character name before the next twelve chapters are built on it." },
        ] },
    ...
    guidance: {
      ...
      explain: { direct: "Explain WHY consistent inputs produce consistent output. Say what the business no longer has to do.",
        ladder: [
          ...
          { rung: "example", context: "a printer and paper of one weight",
            pattern: "consistent input, then the work that no longer has to be done",
            text: "In a different context: a printer given paper of one weight does not have to reset the press between jobs." },
        ] },
    ...
    guidance: {
      ...
      explain: { direct: "Explain WHY ordering to demand shortens the wait. Say which wait disappears.",
        ladder: [
          ...
          { rung: "direction", text: "Separate the time spent working from the time spent waiting, then say which of the two your strategy changes." },
          ...
          { rung: "example", context: "a kitchen and its bookings",
            pattern: "what is prepared against, then the wait that disappears",
            text: "In a different context: a kitchen that preps to the bookings does not wait for the wrong prep to be redone." },
        ] },
    ...
    guidance: {
      ...
      explain: { direct: "Explain WHY this equipment, at this step, changes the whole process rather than one part of it.",
        ladder: [
          ...
          { rung: "example", context: "a road and its narrowest section",
            pattern: "the constraint, then what shortening it does to the whole",
            text: "In a different context: widening the narrowest section of a road changes the journey; widening a section that was already clear does not." },
        ] },
    ...
    guidance: {
      ...
      explain: { direct: "Explain WHY the cost changes shape. Say what the business was paying for before.",
        ladder: [
          ...
          { rung: "direction", text: "Contrast what the business paid for capacity with what it now pays for use, and say which of the two your sentence is about." },
          ...
          { rung: "example", context: "hiring a van against owning one",
            pattern: "paying for capacity against paying for use",
            text: "In a different context: hiring a van for the two days you move costs less than owning one you use twice a year." },
        ] },
    ...
    guidance: {
      ...
      explain: { direct: "Explain WHY held stock costs money even when nothing is bought that month.",
        ladder: [
          ...
          { rung: "direction", text: "Name at least two of them: the space, the handling, the insurance, and the money that cannot be spent on anything else." },
          ...
          { rung: "example", context: "a second fridge bought for one party",
            pattern: "what is held, then what holding it costs while it sits",
            text: "In a different context: a second fridge bought for one party costs power in every week there is no party." },
        ] },
    ...
    guidance: {
      ...
      explain: { direct: "Explain WHY shared parts make the range easier to change. Say what does not have to change.",
        ladder: [
          ...
          { rung: "example", context: "a menu built on one stock",
            pattern: "what is shared, then what does not have to change",
            text: "In a different context: a menu built on one stock can add a dish without a new delivery." },
        ] },
    ...
    guidance: {
      ...
      explain: { direct: "Explain WHY this is flexibility, and be honest about what it costs.",
        ladder: [
          ...
          { rung: "example", context: "one oven and a changing menu",
            pattern: "what one thing can be set for, then what it costs to be able to",
            text: "In a different context: one oven that roasts and bakes serves a changing menu, and does neither as fast as a dedicated one." },
        ] },
